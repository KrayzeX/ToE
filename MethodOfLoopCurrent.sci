...
//Строка матрицы контурных токов представлена в виде [react1 react2 i1/u1],
//где react1 - коэффициент при реактивном элементе с меньшим номером ветви,
//react2 - коэффициент при реактивном элементе с большим номером ветви,
//i1/u1 - воздействие.
